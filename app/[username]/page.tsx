              ...
              <div className="min-h-screen bg-gray-50">
                  ...
                  {/* Header */}
                    <div className="bg-blue-600 text-white px-4 pt-12 pb-8">
                            <h1 className="text-2xl font-bold">{businessName}</h1>h1>
                        {trade && <p className="text-blue-100 text-sm capitalize mt-0.5">{trade}</p>p>}
                        {location && <p className="text-blue-100 text-sm mt-0.5">📍 {location}</p>p>}
                    ...
                    <div className="px-4 py-6">
                        {jobsWithPhotos.length === 0 ? (
                            <div className="text-center py-16 text-gray-400">
                                        <p className="text-lg">No completed jobs yet.</p>p>
                            </div>div>
                          ) : (
                                              ...
                                              return (
                                                                  <div key={job.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                                                                                    ...
                                                                                    <div className="grid grid-cols-2">
                                                                                        {before && (
                                                                                            <div className="relative aspect-square">
                                                                                                                    ...
                                                                                                                    <span className="absolute top-2 left-2 bg-black/60 text-white text-xs px-2 py-0.5 rounded">Before</span>span>
                                                                                                </div>div>
                                                                                                        )}
                                                                                        {after && (
                                                                                            <div className={`relative aspect-square ${!before ? "col-span-2" : ""}`}>
                                                                                                                    ...
                                                                                                                    <span className="absolute top-2 left-2 bg-black/60 text-white text-xs px-2 py-0.5 rounded">After</span>span>
                                                                                                </div>div>
                                                                                                        )}
                                                                                        </div>div>
                                                                      ...
                                                                      {/* Job details */}
                                                                                    <div className="p-4">
                                                                                        {job.description && (
                                                                                            <p className="text-sm font-medium text-gray-800">{job.description}</p>p>
                                                                                                        )}
