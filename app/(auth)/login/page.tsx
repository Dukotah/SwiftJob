...
import { Camera, FileText, DollarSign, ChevronRight, Zap } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* ── Blue hero section ─────────────────────────── */}
      <div className="flex-1 bg-gradient-to-b from-blue-600 to-blue-700 flex flex-col items-center justify-center px-6 pt-16 pb-12">
        {/* Logo */}
        <div className="flex items-center gap-3 mb-3">
          <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center">
            <Zap size={26} color="white" />
          </div>
          <span className="text-3xl font-bold text-white tracking-tight">SwiftJobs</span>
        </div>

        {/* Tagline */}
        <p className="text-blue-200 text-center text-base mb-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-xs font-semibold">Snap</span>
          </div>

          <ChevronRight size={16} className="text-blue-300 mb-5" />
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-xs font-semibold">Invoice</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-xs font-semibold">Get paid</span>
          </div>
        </div>
      </div>

      {/* ── White card bottom section ─────────────────── */}
      <div className="bg-white rounded-t-[32px] px-6 pt-8 pb-10 -mt-4">
        {emailSent ? (
